...
QMAKE    = /usr/bin/qmake
towerdefense.xcodeproj/project.pbxproj: towerdefense.pro  /usr/local/Qt4.7/mkspecs/macx-xcode/qmake.conf /usr/local/Qt4.7/mkspecs/common/unix.conf \
	...
	$(QMAKE) -spec /usr/local/Qt4.7/mkspecs/macx-xcode -o towerdefense.xcodeproj/project.pbxproj towerdefense.pro
